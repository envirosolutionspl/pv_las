...
class PobierzBdotTask(QgsTask):
    ...
    def __init__(self, description, drogi_layer, linie_layer, features, drogi_list, linie_list, iface, wczytajBdot10kBtn, analizaBtn):
    ...
    def finished(self, result):
        ...
        if result:
            ...
            drogi_polaczone=processing.run("qgis:mergevectorlayers", parameters)['OUTPUT']
